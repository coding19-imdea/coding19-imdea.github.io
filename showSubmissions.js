...
if (submissions[48] == undefined) {submissions[48] = "";}
submissions[48] = submissions[48].concat('<li>Marga: ' + showcode(48,"https://raw.githubusercontent.com/coding19-imdea/coding19-imdea.github.io/master/submissions/problem48/Marga.cpp", "C++") + '</li>'
);
if (submissions[49] == undefined) {submissions[49] = "";}
submissions[49] = submissions[49].concat('<li>Cesar: ' + showcode(49,"https://raw.githubusercontent.com/coding19-imdea/coding19-imdea.github.io/master/submissions/problem49/Cesar.ml", "ocaml") + '</li>'
);
if (submissions[49] == undefined) {submissions[49] = "";}
submissions[49] = submissions[49].concat('<li>Martin: ' + showcode(49,"https://raw.githubusercontent.com/coding19-imdea/coding19-imdea.github.io/master/submissions/problem49/Martin.hs", "Haskell") + '</li>'
);
if (submissions[49] == undefined) {submissions[49] = "";}
submissions[49] = submissions[49].concat('<li>The Wonderful Wizard of: ' + showcode(49,"https://raw.githubusercontent.com/coding19-imdea/coding19-imdea.github.io/master/submissions/problem49/Wizard.oz", "Oz") + '</li>'
);
if (submissions[49] == undefined) {submissions[49] = "";}
...
if (submissions[49] == undefined) {submissions[49] = "";}
submissions[49] = submissions[49].concat('<li>Louis-Marie: ' + showcode(49,"https://raw.githubusercontent.com/coding19-imdea/coding19-imdea.github.io/master/submissions/problem49/Louis-Marie.py", "Python") + '</li>'
);
if (submissions[49] == undefined) {submissions[49] = "";}
submissions[49] = submissions[49].concat('<li>Ignacio: ' + showcode(49,"https://raw.githubusercontent.com/coding19-imdea/coding19-imdea.github.io/master/submissions/problem49/Ignacio.rs", "Rust") + '</li>'
);
if (submissions[49] == undefined) {submissions[49] = "";}
...
if (submissions[50] == undefined) {submissions[50] = "";}
submissions[50] = submissions[50].concat('<li>Martin: ' + showcode(50,"https://raw.githubusercontent.com/coding19-imdea/coding19-imdea.github.io/master/submissions/problem50/Martin.hs", "Haskell") + '</li>'
);
if (submissions[50] == undefined) {submissions[50] = "";}
submissions[50] = submissions[50].concat('<li>Ale: ' + showcode(50,"https://raw.githubusercontent.com/coding19-imdea/coding19-imdea.github.io/master/submissions/problem50/Ale.cpp", "c++") + '</li>'
);
if (submissions[50] == undefined) {submissions[50] = "";}
submissions[50] = submissions[50].concat('<li>Marga: ' + showcode(50,"https://raw.githubusercontent.com/coding19-imdea/coding19-imdea.github.io/master/submissions/problem50/Marga.cpp", "c++") + '</li>'
);
